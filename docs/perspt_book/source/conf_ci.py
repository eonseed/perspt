...
latex_elements = {
    ...
    'pointsize': '10pt',
    'preamble': r'''
% LuaLaTeX Unicode and font configuration for CI
\usepackage{fontspec}
\usepackage{unicode-math}

% Font selection with fonts available on Ubuntu CI
...
% Configure emoji fonts for LuaLaTeX with system fonts
\usepackage{newunicodechar}

% Try to use Noto Color Emoji with fallbacks for CI
\IfFontExistsTF{Noto Color Emoji}{
    ...
    \IfFontExistsTF{Noto Emoji}{
        ...
        % Fallback to a basic font that can handle Unicode
        \newfontfamily\emojifont{DejaVu Sans}
    }
}

% Graceful emoji fallback - if font fails, show text alternative
\newcommand{\safeunicode}[2]{%
    \ifdefined\emojifont
        {\emojifont #1}%
    \else
        #2%
...
% Define all emojis used in documentation with fallback text
\newunicodechar{🎉}{\safeunicode{🎉}{[celebration]}}
\newunicodechar{🎨}{\safeunicode{🎨}{[art]}}
\newunicodechar{🎯}{\safeunicode{🎯}{[target]}}
\newunicodechar{🏗}{\safeunicode{🏗}{[construction]}}
\newunicodechar{🐌}{\safeunicode{🐌}{[snail]}}
\newunicodechar{👁}{\safeunicode{👁}{[eye]}}
\newunicodechar{📋}{\safeunicode{📋}{[clipboard]}}
\newunicodechar{📖}{\safeunicode{📖}{[book]}}
\newunicodechar{📚}{\safeunicode{📚}{[books]}}
\newunicodechar{📜}{\safeunicode{📜}{[scroll]}}
\newunicodechar{📦}{\safeunicode{📦}{[package]}}
\newunicodechar{🔀}{\safeunicode{🔀}{[shuffle]}}
\newunicodechar{🔄}{\safeunicode{🔄}{[refresh]}}
\newunicodechar{🔒}{\safeunicode{🔒}{[lock]}}
\newunicodechar{🔗}{\safeunicode{🔗}{[link]}}
\newunicodechar{🔧}{\safeunicode{🔧}{[wrench]}}
\newunicodechar{🚀}{\safeunicode{🚀}{[rocket]}}
\newunicodechar{🚫}{\safeunicode{🚫}{[prohibited]}}
\newunicodechar{🛠}{\safeunicode{🛠}{[tools]}}
\newunicodechar{🛡}{\safeunicode{🛡}{[shield]}}
\newunicodechar{🤖}{\safeunicode{🤖}{[robot]}}
\newunicodechar{🦀}{\safeunicode{🦀}{[crab]}}

% Additional common emojis that might be used
\newunicodechar{✨}{\safeunicode{✨}{[sparkles]}}
\newunicodechar{⚡}{\safeunicode{⚡}{[lightning]}}
\newunicodechar{⚙}{\safeunicode{⚙}{[gear]}}

% Emoji command for manual usage
\newcommand{\emoji}[1]{\safeunicode{#1}{[emoji]}}
''',
